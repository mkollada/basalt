...
def default_config():
    ...
    log_interval = 1
    # TODO fix this
    data_root = '/Users/mattkollada/PycharmProjects/basalt/data/MineRLBasaltFindCave-v0/'
    ...
    save_dir = '/Users/mattkollada/PycharmProjects/basalt/results/MineRLBasaltFindCave-v0/20210916_1000_adoring_elion'
